...
- (NSArray *) listaDeVinos{
    ...
    return @[[[Vino alloc]initWithVino:@"Aalto" andDO:@"Riber del Duero" andCosecha:@"2006"],
             [[Vino alloc]initWithVino:@"Marques Riscal" andDO:@"Rueda" andCosecha:@"2012"],
             [[Vino alloc]initWithVino:@"Pesquera" andDO:@"La Rioja" andCosecha:@"2001"]];
}
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    JAMViewVinos * controller = [[JAMViewVinos alloc]initWithStyle:UITableViewStylePlain AndModel:[self listaDeVinos]];
